...
class DB
{
    ...
    public static function init()
    {
        ...
        self::$handle->exec('CREATE TABLE IF NOT EXISTS todo (id INT NOT NULL AUTO_INCREMENT, PRIMARY KEY (id), description TEXT NOT NULL, due INT NOT NULL, user_id INT NOT NULL REFERENCES user(id))');
    }
}
